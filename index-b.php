...
<body>
	...
	<div id="page-wrapper"> 
	    ...
	    <h6 style="text-align: center; color: rgb(255, 255, 255); margin: 8px 0px;">Energy is for Wimps</h6>
            <ul id="nav">
		...
		<a title="RCPD Ranks" alt="RCPD Ranks" onclick="javascript:topButtonClicked(this);" order="1"  id="rcpd-button" class="button extend fancybox-link" data-fancybox-type="iframe"  href="http://night.org/swat2/playerdb/index.php?p=view">
